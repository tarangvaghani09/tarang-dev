              ...
              {["Expertise", "Projects", "Contact"].map((item) => (
                <SheetClose asChild key={item}>
                  <motion.button
                    ...
                    className="min-h-14 w-full text-left px-6 py-4 rounded-2xl text-xl font-semibold bg-white/70 text-[#1b1b1b] shadow-sm shadow-black/10 hover:bg-[#1b1b1b] hover:text-white active:scale-[0.98] transition-all duration-200 dark:bg-slate-900/90 dark:text-white/90 dark:hover:bg-white dark:hover:text-[#111]"
                  >
                    {item}
                  </motion.button>
                </SheetClose>
